...
function buildKeywordRules(): Record<number, Rule[]> {
  return {
    4: [
      ...
      { key: 'unit',          patterns: [/\bkg\b|\bcm\b|\bmm\b|\bkm\b|meter|litre|\bml\b|gram|unit.*measurement|convert.*unit|capacity|temperature|money|transaction|cost|price|rupee|score|gross|dozen/i] },
      { key: 'decimal',       patterns: [/decimal|point|tenth|hundredth|decimal.*fraction/i] },
      { key: 'operation',     patterns: [/bodmas|order of operation|bracket|simplif|ratio|proportion|multiply|divide|product|quotient/i] },
